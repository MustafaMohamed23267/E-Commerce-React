...
import commerce11 from '../assets/commerce11.jpg';
...
{/* <div id="default-carousel" className="relative w-full" data-carousel="slide">
    ...
    <div className="relative h-56 overflow-hidden rounded-base md:h-96">
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={commerce} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="home" />
        </div>
       
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={commerce1} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="comerce" />
        </div>
  
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={commerce2} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>

        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src={commerce11} class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
    </div>
